          <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Create New Casir Account!</h1>
           	</div>
           	<form class="user" id="UsrBru">
                <div class="form-group" id="col_CasirName">
                    <input type="text" class="form-control form-control-user Diisi" name="name" id="CasirName" placeholder="Casir Name" value="">
