...
<head>
  ...
  <title>Tb Sumber Rejeki - Login</title>
  ...
  <style>
    body{
      background-image: url("<?php echo base_url('gambar/DSC_00182.JPG') ?>");
...
<body>
  ...
  <div class="container" style="margin-top: 70px;">
    ...
    <div class="card o-hidden border-0  my-5 col-lg-5 offset-lg-3" 
    style="background-color:#fffefe08; box-shadow: 0 1rem 3rem black!important">
          ...
          <div class="col-lg">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4" style="color: white !important;">Login</h1>
